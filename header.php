  ...
  <header id="header">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <a href="index.php" class="logo"><img src="images\Universo.jpg" alt="" style="height:185px;" align="middle"></a>
        </div>
      </div>
    </div>
  </header>
...
?>
		...
		?>
            ...
            <li><a href="groupchat.php">Messages</a></li>
      ...
      <div class="col-lg-12 col-md-12">
        <div class="latest_newsarea"> <span>Latest News</span>
          ...
          <div class="social_area">
            <ul class="social_nav">
              <li class="facebook"><a href="https://www.facebook.com/sseptp/"></a></li>
              <li class="twitter"><a href="https://mobile.twitter.com/sseputtaparthi"></a></li>
              <li class="pinterest"><a href="https://www.instagram.com/sgiptpofficial/?hl=en"></a></li>
              <li class="youtube"><a href="https://www.youtube.com/channel/UCDPQVkgqr3gO-EOSYDnX-uA"></a></li>
